...
export const projects: Project[] = [
    {
        ...
        description: 'A real-time chat application powered by OpenAI GPT-4 with conversation memory and multi-language support.',
    ...
    },
    {
        ...
        description: 'Modern, responsive portfolio website built with Next.js and Framer Motion animations.',
