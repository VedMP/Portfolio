...
export const projects: Project[] = [
  {
    id: "1",
    title: "Smart Document Assistant | IBM Generative AI Engineering Capstone Project",
    description:
    ...
    category: "AI",
    github: "https://github.com/VedMP/IBM-Generative-AI-Engineering-Capstone-Project-Ved-Patel",
    featured: true,
  },
  {
    id: "2",
