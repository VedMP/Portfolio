...
export default function ExperienceSection() {
    ...
    return (
        <section id="experience" className="relative w-full py-24 md:py-32">
            ...
            <div className="w-full flex justify-center" style={{ paddingLeft: '20px', paddingRight: '20px' }}>
                <div className="w-full max-w-4xl">
                    ...
                    >
                        ...
                        <p className="text-slate-400 max-w-2xl mx-auto">My professional journey and academic background</p>
                    </motion.div>
                    ...
                    <div className="mb-16">
                        ...
                        <div className="space-y-6">
                            {workExperience.map((exp, index) => (
                                <TimelineCard key={exp.id} experience={exp} index={index} color="blue" />
                            ))}
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="space-y-6">
                            {education.map((exp, index) => (
                                <TimelineCard key={exp.id} experience={exp} index={index} color="violet" />
                            ))}
                        </div>
                    </div>
                </div>
 ...
 */
function TimelineCard({ experience, index, color }: { experience: Experience; index: number; color: 'blue' | 'violet' }) {
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-wrap items-start justify-between gap-2 mb-2">
                ...
                <span className={`px-3 py-1 text-xs font-medium rounded-full ${experience.endDate === 'Present' ? 'bg-green-500/20 text-green-400' : 'bg-slate-700 text-slate-400'
                    }`}>
            ...
            <div className="flex flex-wrap gap-2">
                {experience.technologies.map((tech) => (
                    <span key={tech} className="px-2 py-1 text-xs rounded-md bg-slate-700/50 text-slate-400">
                        {tech}
                    </span>
                ))}
            </div>
