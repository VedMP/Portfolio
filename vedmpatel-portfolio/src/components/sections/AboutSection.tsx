                ...
                <div className="w-full max-w-6xl">
                    ...
                    >
                        ...
                        <p className="text-slate-400 max-w-2xl mx-auto">
                            A passionate developer with a drive for creating impactful solutions
                        </p>
                    </motion.div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        ...
                        >
                            ...
                            <div className="space-y-6 text-slate-300 leading-relaxed">
                                <p>
                                    I'm <span className="text-white font-semibold">Ved Patel</span>, an Honours Computer Science student
                                    at <span className="text-blue-400 font-medium">Ontario Tech University</span>. My journey in tech
                                    started with a curiosity about how software shapes our daily lives.
                                </p>
                                <p>
                                    I specialize in full-stack development, working with modern frameworks like React, Next.js, and
                                    Node.js. I'm particularly interested in creating user-centric experiences.
                                </p>
                            </div>
